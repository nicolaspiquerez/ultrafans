        ...
        <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto pb-4 -mx-6 px-6 md:mx-0 md:px-0 snap-x snap-mandatory">
          {sports.map((s, i) => (
            <motion.div
              ...
              className="relative min-w-[280px] md:min-w-0 aspect-[3/4] rounded-2xl overflow-hidden group cursor-pointer snap-center"
            >
              <img
                src={s.img}
                alt={s.sport}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <h3 className="font-display text-2xl font-bold text-brand-white mb-1">{s.sport}</h3>
